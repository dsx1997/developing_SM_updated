                                ...
                                <table class="table table-bordered table-striped" style="text-align: left">
                                    ...
                                    <tbody id="exam_class_tbody">
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">Pending publishing by <span style="color:red"> @if($examrecord->flag==1) Class teacher
                                                    @elseif($examrecord->flag==2) Class supervisor
                                                    @elseif($examrecord->flag==3) Dean
                                                    @elseif($examrecord->flag==4) published
                                                    @endif
                                                </span> </td>
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered table-stream">
                                    ...
                                    <tbody id="exam_class_tbody_stream">
                                        @foreach($myclass->class_subject as $classsubject)
                                        @if(count($classsubject->subject->exam_record) == 0)
                                        <tr>
                                            <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">Form {{$myclass->form->name}} {{$myclass->stream}}</td>
                                            <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">{{$classsubject->subject->title}}</td>
                                ...
                                <table class="table table-bordered table-striped" style="text-align: left">
                                    ...
                                    <tbody id="exam_class_tbody">
                                        ...
                                        <tr>
                                            ...
                                            @else <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">{{$k}}/{{count($myclass->students)}} Don't have marks.</td>
                                            @endif
                                            <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">Pending publishing by <span style="color:red"> @if($examrecord->flag==1) Dean
                                                    @elseif($examrecord->flag==2) Super teacher
                                                    @elseif($examrecord->flag==3) class teacher
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered table-stream">
                                    ...
                                    <tbody id="exam_class_tbody_stream">
                                        ...
                                        @else
                                        @foreach($classsubject->subject->exam_record as $exam_rec)
                                        @if($exam_rec->exam_id !=$exam_id)
                                        <tr>
                                            <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">Form {{$myclass->form->name}} {{$myclass->stream}}</td>
                                            <td style="font-size:16px;font-family: 'Times New Roman', Times, serif;">{{$classsubject->subject->title}}</td>
                                            @if($classsubject->subject->class_subject->teacher_id == null)
