    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-6 text-left pt-2 pl-3">
                <a href="/exams" class="btn btn-secondary" style="color:black"><svg xmlns="http://www.w3.org/2000/svg" style="float:left;margin-top:3px;color:black;margin-right:5px" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
